...
SchemaFor200ResponseBodyApplicationJson = ContributionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_contributions_by_id_oapg(
        self,
...
class GetContributionsById(BaseApi):
    ...
    def get_contributions_by_id(
        ...
        return self._get_contributions_by_id_oapg(
