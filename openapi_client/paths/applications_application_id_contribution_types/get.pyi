...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ContributionTypeResponse'], typing.List['ContributionTypeResponse']],
...
class BaseApi(api_client.Api):
    ...
    def _get_contribution_types_oapg(
        self: api_client.Api,
...
class GetContributionTypes(BaseApi):
    ...
    def get_contribution_types(
        ...
        return self._get_contribution_types_oapg(
