...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ReviewResponse']:
            return ReviewResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ReviewResponse'], typing.List['ReviewResponse']],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_reviews_by_contribution_oapg(
        self,
...
class GetReviewsByContribution(BaseApi):
    ...
    def get_reviews_by_contribution(
        ...
        return self._get_reviews_by_contribution_oapg(
