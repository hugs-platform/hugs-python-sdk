...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ContributionResponse']:
            return ContributionResponse

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ContributionResponse'], typing.List['ContributionResponse']],
...
class FindByReviewerId(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_by_reviewer_id(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def find_by_reviewer_id(
        ...
        return self._find_by_reviewer_id_oapg(
