...
class BaseApi(api_client.Api):
    ...
    def _create_contribution_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_contribution_request.serialize(body, content_type)
...
class CreateContribution(BaseApi):
    ...
    def create_contribution(
        ...
        return self._create_contribution_oapg(
            body=body,
