...
# body param
SchemaForRequestBodyApplicationJson = ApplicationRequest


request_body_application_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_application_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_application_request.serialize(body, content_type)
