...
from openapi_client.apis.paths.contributions_authentication import ContributionsAuthentication
...
PathToApi = typing_extensions.TypedDict(
    'PathToApi',
    {
        ...
        PathValues.CONTRIBUTIONS_AUTHENTICATION: ContributionsAuthentication,
